...
<head>
    ...
    <meta name="description" content="Debt Collector Admin">
    <meta name="keywords" content="HTML,CSS,JavaScript">
    <meta name="author" content="Rennard">
    @vite('resources/css/app.css')
    <title>Login | Debt Collector Admin</title>
...
<body class="bg-zinc-900">
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 ">
        <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExd3YzNjljY2I1MWdhOG9iYWpkeGdoZndndXQ1N3F5bDZqZ3piMW9vNiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/vtOV8OFqUmwDhLC3hb/giphy.gif"
            alt="Hello" class="size-40 items-center justify-center block">
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('login_post') }}" method="POST">
                    @csrf
                    <div>
                        <label for="email"
